...
def register():
    ...
    try:
        query = cursor.execute(
            "INSERT INTO USER(name,address,email,phone,pass)VALUES('" + getname + "','" + getaddress + "','" + getemail + "','" + getphone + "','" + getpass + "')")
        print(query)
        conn.commit()
...
def addbooks():
    ...
    try:
        query = cursor.execute(
            "INSERT INTO BOOK(name,author,category,price,publisher)VALUES('" + getname + "','" + getauthor + "','" + getcategory + "','" + getprice + "','" + getpublisher + "')")
        print(query)
        conn.commit()
...
def vieupdate():
    ...
    try:
        cursor.execute(
            "UPDATE BOOK SET name='" + getname + "',author='" + getauthor + "',category='" + getcategory + "',price='" + getprice + "',publisher='" + getpublisher + "'WHERE name='" + getname + "'")
        conn.commit()
        return redirect("/viewall")
    except Exception as e:
        print(e)
